class PlaylistControl extends Control {
    ...
    this.backwardButton = {
      ...
      span: -10
        ...
        triangle(this.forwardButton.x + this.forwardButton.span, 
          this.forwardButton.y, 
          this.forwardButton.x + this.forwardButton.span + this.forwardButton.width, 
          this.forwardButton.y + this.forwardButton.height/2, 
          this.forwardButton.x + this.forwardButton.span, 
          this.forwardButton.y + this.forwardButton.height);

        // Backward button draw
        triangle(this.backwardButton.x,
        ...
        triangle(this.backwardButton.x + this.backwardButton.span,
          this.backwardButton.y,
          this.backwardButton.x - this.backwardButton.width + this.backwardButton.span,
          this.backwardButton.y + this.backwardButton.height/2,
      ...
      if(mouseX > this.forwardButton.x && mouseX < this.forwardButton.x + this.forwardButton.width + this.forwardButton.span &&
        mouseY > this.forwardButton.y && mouseY < this.forwardButton.y + this.forwardButton.height){
          for(let playlist of this.playlists){
            if(playlist.name === this.selector.value()){
              this.selectedSong++;
      ...
      if(mouseX > this.backwardButton.x - this.backwardButton.width + this.backwardButton.span && mouseX < this.backwardButton.x &&
        mouseY > this.backwardButton.y && mouseY < this.backwardButton.y + this.backwardButton.height){
          for(let playlist of this.playlists){
            if(playlist.name === this.selector.value()){
              this.selectedSong--;
